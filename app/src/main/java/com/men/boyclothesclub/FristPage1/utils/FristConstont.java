...
public class FristConstont {
    public final static int HANDER_TAG_AD = 111;
    public final static int HANDER_TAG_LIST = 110;
    public final static int HANDER_TAG_AD_TIMER = 1111;
    public final static int HANDER_TAG_TAG = 112;
